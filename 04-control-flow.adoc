...
For example, we will buy eggs only _if_ their price is less than some value. Or, _if_ it is raining, we will bring an umbrella, otherwise (_else_) we will bring sunglasses.
