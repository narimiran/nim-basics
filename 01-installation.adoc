...
Whichever way you choose, just follow the installation procedure explained at each link and Nim should be installed. We will check that the installation went well in a comming chapter.
...
In this tutorial we will use the stable version, which is Nim 0.18.0 at the time of writing.
