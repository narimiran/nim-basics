...
https://nim-lang.org/[Nim] is a relatively new programming language which allows the users to write an easy-to-read high-performance code.
But if you are reading this Nim tutorial, the chances are that you already know about Nim.

The tutorial is available both https://narimiran.github.io/nim-basics/[online] and as a https://github.com/narimiran/nim-basics/raw/master/nim-basics.pdf[PDF].
...
If you need additional help understanding some parts of the tutorial or with the exercises, you can always ask for help on the https://forum.nim-lang.org/[Nim forum], the https://gitter.im/nim-lang/Nim[Nim Gitter channel], or Nim's IRC channel on freenode, #nim.
